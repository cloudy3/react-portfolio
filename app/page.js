      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        ...
        <section>
          ...
          <div className="flex flex-col lg:flex-row gap-7">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 basis-1/3 flex-1 dark:bg-gray-200">
              ...
              <p className="py-2">Lorum Ipsum</p>
        ...
        <section>
          ...
          <div className="flex flex-col gap-7 py-10 lg:flex-row lg:flex-wrap">
            ...
            <div className="basis-1/3 flex-1">
              <Image src={web2} className="rounded-lg object-cover" width={"100%"} height={"100%"} responsive/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web3} className="rounded-lg object-cover" width={"100%"} height={"100%"} responsive/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web4} className="rounded-lg object-cover" width={"100%"} height={"100%"} responsive/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web5} className="rounded-lg object-cover" width={"100%"} height={"100%"} responsive/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web6} className="rounded-lg object-cover" width={"100%"} height={"100%"} responsive/>
            </div>
          </div>
        </section>
      </main>
